...
public class SF_Praga1 {
	...
	public void setUp() {
		...
		username.sendKeys("gokuls2381@gmail.com");
		password.sendKeys("Roulette@123");
		loginButton.click();
	...
	public void EditTask() throws InterruptedException{
		...
		driver.findElement(By.xpath("//lightning-datepicker//input")).sendKeys("27/08/2023");
