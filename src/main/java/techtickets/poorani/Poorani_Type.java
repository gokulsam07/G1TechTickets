...
public class Poorani_Type {
	...
	public void withoutMandatoryFields() {
		...
		driver.findElement(By.xpath("//p/mark[text() = 'Work Type Groups']")).click();
		driver.findElement(By.xpath(
				"//div[@class='slds-context-bar__label-action slds-p-left--none slds-p-right--x-small']//lightning-primitive-icon"))
		.click();
	...
	public void deleteWorkTypeGroup()
	{
		...
		driver.findElement(By.xpath("//input[contains(@placeholder, 'Search apps')]")).sendKeys("Work Type Groups");
		driver.findElement(By.xpath("//p/mark[text() = 'Work Type Groups']")).click();
		driver.findElement(By.xpath("//input[@type='search' and @placeholder = 'Search this list...']")).sendKeys("Automation",Keys.ENTER);
		WebElement arrow = driver.findElement(By.xpath("//a[normalize-space()='Automation']/ancestor::tr/td[5]//a"));
		//arrow.click();
