...
public class Anand {
	...
	public void TC2() throws InterruptedException {
		...
		JavascriptExecutor executor = (JavascriptExecutor)driver;
		executor.executeScript("arguments[0].click();", element);
		driver.findElement(By.xpath("(//a[normalize-space()='Salesforce Automation by Anand'])[1]/ancestor::tr/td[8]/span/div/a")).click();
		driver.findElement(By.xpath("//div[@id='2924:0']//a[@title='Edit']")).click();
		driver.findElement(By.xpath("//input[@name='Name']")).clear();
		driver.findElement(By.xpath("//input[@name='Name']")).sendKeys("Salesforce Automation by Anand Edited");
		driver.findElement(By.xpath("//button[@name='SaveEdit']")).click();
		Assert.assertTrue(driver.findElement(By.xpath("//div[@class='DESKTOP uiContainerManager']")).getText().contains("Edited"));
	}
	...
	public void TC5() throws InterruptedException {	
	    ...
	    JavascriptExecutor executor = (JavascriptExecutor)driver;
	    executor.executeScript("arguments[0].click();", element);
	    driver.findElement(By.xpath("(//input[@type='search'])[2]")).sendKeys("Anand",Keys.ENTER);
	    Thread.sleep(4000);
	    WebElement findElement = driver.findElement(By.xpath("//table[contains(@class,'slds-table forceRecordLayout')]//tr//td[8]//a"));
	    findElement.click();
	    Thread.sleep(1000);
